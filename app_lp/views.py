...
def home_view(request):
    ...
    method_appointments = GetQuote.METHOD_CHOICES
    ...
    if request.method == "POST":
        ...
        if 'get_quote_form' in request.POST:
            ...
            desired_date_of_appointment = request.POST.get("desired_date_of_appointment")
            method_of_appointment = request.POST.get("method_of_appointment")
            ...
            GetQuote.objects.create(
                ...
                desired_date_of_appointment=desired_date_of_appointment,
                method_of_appointment=method_of_appointment
            )
    ...
    context = {
        ...
        'method_appointments': method_appointments,  # Add choices to context
    }
